...
<head>
    ...
    <title>@yield('title') | RAR Piano</title>
...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item mt-2">
                    <a class="log-out " href="#" class="nav-link">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4"  style="background-color: #17356a">
            <!-- Brand Logo -->
            <a href="/ " class="brand-link">
                <img src="/assets/dist/img/rar.png" alt="AdminLTE Logo"
                    class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light"><b>Rumah Piano</b></span>
            </a>
            ...
            <div class="sidebar">
               ...
               <li class="nav-header">USER</li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.product_purchases.index') }}" class="nav-link">
                                <i class="nav-icon fa-solid fa-users"></i>
                                <p>
                                    Products Admin
                                </p>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2024 <a href="https://youtube.com">Rizky Agras Rifaldy</a>.</strong> All rights
            reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
